				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.baoxiumingcheng" type="text" :readonly="ro.baoxiumingcheng" name="baoxiumingcheng" id="baoxiumingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="baoxiuriqi" id="baoxiuriqi" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
                                ...
                                jquery('#baoxiuriqi').val(getCurDate());
				laydate.render({
					elem: '#baoxiuriqi'
				});
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('zhuhubaoxiu/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('zhuhubaoxiu' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
