	...
	<body>
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.fuwuleibie" type="text" :readonly="ro.fuwuleibie" name="fuwuleibie" id="fuwuleibie" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		                <label class="layui-form-label">住宅类型</label>
		                <div class="layui-input-block">
		                    <select name="zhuzhaileixing" id="zhuzhaileixing" lay-filter="zhuzhaileixing"  >
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.xianxingjia" type="text" :readonly="ro.xianxingjia" name="xianxingjia" id="xianxingjia" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">车位费：</label>
						<div class="layui-input-block">
							<input v-model="detail.cheweifei" type="text" :readonly="ro.cheweifei" name="cheweifei" id="cheweifei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.faburen" type="text" :readonly="ro.faburen" name="faburen" id="faburen" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<button v-if="!ro.fengmiantupian" type="button" class="layui-btn btn-theme" id="fengmiantupianUpload">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(zhuzhaileixing)', function (data) {
                    vue.detail.zhuzhaileixing=data.value;
                });
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='fuwuleibie'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.fuwuleibie = true;
                                                continue;
                                        }
                                        if(o=='zhuzhaileixing'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.zhuzhaileixing = true;
                                                continue;
                                        }
                                        if(o=='xianxingjia'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.xianxingjia = true;
                                                continue;
                                        }
                                        if(o=='cheweifei'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.cheweifei = true;
                                                continue;
                                        }
                                        if(o=='fabushijian'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('shoufeibiaozhun/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('shoufeibiaozhun' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
