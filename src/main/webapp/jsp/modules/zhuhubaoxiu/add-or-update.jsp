...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑住户报修</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑住户报修</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">住户报修信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>报修名称</label>
										<input name="baoxiumingcheng" id="baoxiumingcheng" name="baoxiumingcheng" class="form-control" placeholder="报修名称">
									</div>
									<div class="form-group col-md-6">
										<label>类型</label>
										<select id="leixingSelect" name="leixing" class="form-control">
												<option value=""></option>
												<option class="leixingOption" value="水工">
													水工
												</option>
												<option class="leixingOption" value="电工">
													电工
												</option>
												<option class="leixingOption" value="木工">
													木工
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>报修内容</label>
										<textarea  name="baoxiuneirong" class="form-control" id="baoxiuneirong" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>报修日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zhuhubaoxiu/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("zhuhubaoxiu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("zhuhubaoxiu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dataBind(){
			...
			$("#baoxiumingcheng").val(ruleForm.baoxiumingcheng);	
			...
			$("#baoxiuneirong").val(ruleForm.baoxiuneirong);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.baoxiumingcheng != null && res.data.baoxiumingcheng != ''){

						$("#baoxiumingcheng").val(res.data.baoxiumingcheng);
						$("#baoxiumingcheng").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.baoxiuneirong != null && res.data.baoxiuneirong != ''){

						$("#baoxiuneirong").val(res.data.baoxiuneirong);
					}
