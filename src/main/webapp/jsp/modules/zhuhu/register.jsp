...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210817/5062a0aa8c48412fa67460bab186638b.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		border-width: 6px;
		border-style: solid;
		border-color: rgba(192, 232, 242, 1);
		background-color: rgba(192, 232, 242, 0.6);
	...
	#login-wrapper h1 {
		...
		background-color: rgba(45, 111, 138, 1);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
		text-align: center;
	}
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">住户账号</label> 
							<input  name="zhuhuzhanghao" placeholder="住户账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">住户姓名</label> 
							<input  name="zhuhuxingming" placeholder="住户姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">住户手机</label> 
							<input  name="zhuhushouji" placeholder="住户手机" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">住户号</label> 
							<input  name="zhuhuhao" placeholder="住户号" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "zhuhu/register";
				$.ajax({ 
					type: "POST",
					url: url,
