...
public class WuyeController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WuyeEntity user = wuyeService.selectOne(new EntityWrapper<WuyeEntity>().eq("wuyezhanghao", username));
    ...
    public R register(@RequestBody WuyeEntity wuye){
    	...
    	WuyeEntity user = wuyeService.selectOne(new EntityWrapper<WuyeEntity>().eq("wuyezhanghao", wuye.getWuyezhanghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,WuyeEntity wuye, 
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,WuyeEntity wuye, 
		HttpServletRequest request){
        EntityWrapper<WuyeEntity> ew = new EntityWrapper<WuyeEntity>();
    	PageUtils page = wuyeService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, wuye), params), params));
		request.setAttribute("data", page);
