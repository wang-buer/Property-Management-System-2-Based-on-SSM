...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">住户投诉管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>住户投诉列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">住户投诉列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										住户姓名
									</label>
									<input type="text" id="zhuhuxingmingSearch" class="form-control form-control-sm" placeholder="请输入住户姓名" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zhuhushouji')">住户手机<i id="zhuhushoujiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zhuhuhao')">住户号<i id="zhuhuhaoIcon" class="fa fa-sort"></i></th>
											<th>投诉内容</th>
											<th onclick="sort('tousushijian')">投诉时间<i id="tousushijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#zhuhuxingmingSearch').val() != null && $('#zhuhuxingmingSearch').val() != ''){
				searchForm.zhuhuxingming ="%" +  $('#zhuhuxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("zhuhutousu/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				zhuhuxingming : searchForm.zhuhuxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var zhuhushoujiCell  = document.createElement('td');

						 zhuhushoujiCell.innerHTML = item.zhuhushouji;

			row.appendChild(zhuhushoujiCell);
			...
			var tousushijianCell  = document.createElement('td');

						  tousushijianCell.innerHTML = item.tousushijian;


			row.appendChild(tousushijianCell);
		...
		function sh(){
			...
			httpJson("zhuhutousu/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhuhutousu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zhuhutousu");
