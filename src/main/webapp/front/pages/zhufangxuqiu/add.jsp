	...
	<body>
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.xuqiu" type="text" :readonly="ro.xuqiu" name="xuqiu" id="xuqiu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		                <label class="layui-form-label">是否解决</label>
		                <div class="layui-input-block">
		                    <select name="shifoujiejue" id="shifoujiejue" lay-filter="shifoujiejue"  >
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.xuqiuren" type="text" :readonly="ro.xuqiuren" name="xuqiuren" id="xuqiuren" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(shifoujiejue)', function (data) {
                    vue.detail.shifoujiejue=data.value;
                });
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='shifoujiejue'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shifoujiejue = true;
                                                continue;
                                        }
                                        if(o=='xuqiuren'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.xuqiuren = true;
                                                continue;
                                        }
                                        if(o=='lianxifangshi'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('zhufangxuqiu/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('zhufangxuqiu' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
