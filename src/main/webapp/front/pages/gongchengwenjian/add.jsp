				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.wenjianbianhao" type="text" :readonly="ro.wenjianbianhao" name="wenjianbianhao" id="wenjianbianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">文件名称：</label>
						<div class="layui-input-block">
							<input v-model="detail.wenjianmingcheng" type="text" :readonly="ro.wenjianmingcheng" name="wenjianmingcheng" id="wenjianmingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">文件：</label>
						<div class="layui-input-inline" style="line-height: 50px;">
							<input type="hidden" :value="detail.wenjian" id="wenjian" name="wenjian" />
		                    <button type="button" class="layui-btn btn-theme" id="wenjianUpload">
								<i class="layui-icon">&#xe67c;</i>上传文件
							</button>
							<a download="文件" :href="detail.wenjian">下载</a>
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">上传时间：</label>
						<div class="layui-input-block">
							<input type="text" name="shangchuanshijian" id="shangchuanshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
                                ...
                                jquery('#shangchuanshijian').val(getCurDate());
				laydate.render({
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        if(o=='wenjianbianhao'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.wenjianbianhao = true;
                                                continue;
                                        }
                                        if(o=='wenjianmingcheng'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.wenjianmingcheng = true;
                                                continue;
                                        }
                                        if(o=='wenjian'){
                                                vue.detail[o] = obj[o];
                                        ...
                                        if(o=='shangchuanshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shangchuanshijian = true;
                                                jquery('#shangchuanshijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='wuyezhanghao'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('gongchengwenjian/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('gongchengwenjian' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
