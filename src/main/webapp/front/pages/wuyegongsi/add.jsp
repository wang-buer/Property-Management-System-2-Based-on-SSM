		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">服务面积：</label>
						<div class="layui-input-block">
							<input v-model="detail.fuwumianji" type="text" :readonly="ro.fuwumianji" name="fuwumianji" id="fuwumianji" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">企业文化：</label>
						<div class="layui-input-block">
							<input v-model="detail.qiyewenhua" type="text" :readonly="ro.qiyewenhua" name="qiyewenhua" id="qiyewenhua" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">注册资金：</label>
						<div class="layui-input-block">
							<input v-model="detail.zhucezijin" type="text" :readonly="ro.zhucezijin" name="zhucezijin" id="zhucezijin" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">资质荣誉：</label>
						<div class="layui-input-block">
							<input v-model="detail.zizhirongyu" type="text" :readonly="ro.zizhirongyu" name="zizhirongyu" id="zizhirongyu" autocomplete="off" class="layui-input">
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='fuwumianji'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.fuwumianji = true;
                                                continue;
                                        }
                                        if(o=='qiyewenhua'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.qiyewenhua = true;
                                                continue;
                                        }
                                        if(o=='zhucezijin'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.zhucezijin = true;
                                                continue;
                                        }
                                        if(o=='zizhirongyu'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.zizhirongyu = true;
                                                continue;
                                        }
                                        if(o=='xiangqing'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('wuyegongsi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('wuyegongsi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
