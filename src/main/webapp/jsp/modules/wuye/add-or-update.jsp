					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑物业</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>邮件</label>
										<input name="youjian" id="youjian" name="youjian" class="form-control" placeholder="邮件">
									</div>
									<div class="form-group col-md-6">
										<label>联系电话</label>
				...
				if(crossrefid && crossuserid) {
					...
					http("wuye/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("wuye/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.youjian != null && res.data.youjian != ''){

						$("#youjian").val(res.data.youjian);
						$("#youjian").attr('readonly','readonly');
					}
