...
<html>
	...
	<body>
			...
			<form class="layui-form login-form" :style='{"padding":"20px","boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"20px","borderWidth":"0","width":"500px","borderStyle":"solid","justifyContent":"center","height":"auto"}'>
				...
				<div class="title" v-if="true" :style='{"padding":"0","boxShadow":"0px 6px 0 0px rgba(240, 86, 84, 1)","margin":"10px auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(18, 18, 18, 1)","isshow":true,"borderRadius":"100%","borderWidth":"0","width":"64px","lineHeight":"38px","fontSize":"15px","borderStyle":"solid"}'>工程文件注册</p></div>
                ...
                <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}' class="form-item">
					<label v-if="true" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#333","borderRadius":"0","textAlign":"left","borderWidth":"0","width":"120px","fontSize":"16px","borderStyle":"solid"}' class="layui-form-label">文件编号：</label>
					<input :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(0,0,0,.5)","borderColor":"#ccc","backgroundColor":"#fff","color":"rgba(241, 58, 58, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"0","width":"200px","fontSize":"16px","borderStyle":"solid","height":"44px"}' type="text" id="wenjianbianhao" name="wenjianbianhao" placeholder="请输入文件编号" autocomplete="off" class="layui-input">
				</div>
                <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}' class="form-item">
					<label v-if="true" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#333","borderRadius":"0","textAlign":"left","borderWidth":"0","width":"120px","fontSize":"16px","borderStyle":"solid"}' class="layui-form-label">文件名称：</label>
					<input :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(0,0,0,.5)","borderColor":"#ccc","backgroundColor":"#fff","color":"rgba(241, 58, 58, 1)","borderRadius":"8px","textAlign":"left","borderWidth":"0","width":"200px","fontSize":"16px","borderStyle":"solid","height":"44px"}' type="text" id="wenjianmingcheng" name="wenjianmingcheng" placeholder="请输入文件名称" autocomplete="off" class="layui-input">
				</div>
                <div :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","width":"80%","borderStyle":"solid","height":"64px"}' class="form-item">
