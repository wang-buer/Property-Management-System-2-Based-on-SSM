			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.neirong" type="text" :readonly="ro.neirong" name="neirong" id="neirong" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('xiaoquguizhang/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('xiaoquguizhang' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
