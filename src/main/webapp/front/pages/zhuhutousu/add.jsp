				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zhuhuzhanghao" type="text" :readonly="ro.zhuhuzhanghao" name="zhuhuzhanghao" id="zhuhuzhanghao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zhuhushouji" type="text" :readonly="ro.zhuhushouji" name="zhuhushouji" id="zhuhushouji" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="tousushijian" id="tousushijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
						  ...
						  carousel.render({
							...
							width: '100%',
						  	...
						  	indicator: 'inside'
                                ...
                                jquery('#tousushijian').val(getCurDate());
				laydate.render({
					elem: '#tousushijian'
				});
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					data = data.data
					for(var key in data){
                        if(key=='zhuhuzhanghao'){
                                vue.detail['zhuhuzhanghao'] = data[`${key}`]
                                vue.ro.zhuhuzhanghao = true;
                                continue;
                        }
                        if(key=='zhuhuxingming'){
                                vue.detail['zhuhuxingming'] = data[`${key}`]
                                vue.ro.zhuhuxingming = true;
                                continue;
                        }
                        if(key=='zhuhushouji'){
                                vue.detail['zhuhushouji'] = data[`${key}`]
                                vue.ro.zhuhushouji = true;
                                continue;
                        }
                        if(key=='zhuhuhao'){
                                vue.detail['zhuhuhao'] = data[`${key}`]
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='tousuneirong'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tousuneirong = true;
                                                continue;
                                        }
                                        if(o=='tousushijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tousushijian = true;
                                                jquery('#tousushijian').val(obj[o]);
                                                continue;
                                        }
					}
				}
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('zhuhutousu/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('zhuhutousu' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
