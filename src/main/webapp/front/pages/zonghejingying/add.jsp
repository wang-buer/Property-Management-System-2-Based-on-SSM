				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.biaotimingcheng" type="text" :readonly="ro.biaotimingcheng" name="biaotimingcheng" id="biaotimingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">开展时间：</label>
						<div class="layui-input-block">
							<input type="text" name="kaizhanshijian" id="kaizhanshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">开展地点：</label>
						<div class="layui-input-block">
							<input v-model="detail.kaizhandidian" type="text" :readonly="ro.kaizhandidian" name="kaizhandidian" id="kaizhandidian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">参与人：</label>
						<div class="layui-input-block">
							<input v-model="detail.canyuren" type="text" :readonly="ro.canyuren" name="canyuren" id="canyuren" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        if(o=='biaotimingcheng'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.biaotimingcheng = true;
                                                continue;
                                        }
                                        if(o=='kaizhanshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.kaizhanshijian = true;
                                                jquery('#kaizhanshijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='kaizhandidian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.kaizhandidian = true;
                                                continue;
                                        }
                                        if(o=='canyuren'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.canyuren = true;
                                                continue;
                                        }
                                        if(o=='neirong'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('zonghejingying/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('zonghejingying' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
