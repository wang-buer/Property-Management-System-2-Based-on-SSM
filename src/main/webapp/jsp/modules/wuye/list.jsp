...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>物业管理</span></li>
								<li class="breadcrumb-item active"><span>物业列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">物业列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										物业账号
									</label>
									<input type="text" id="wuyezhanghaoSearch" class="form-control form-control-sm" placeholder="请输入物业账号" aria-controls="tableId">
									<label>
										物业姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>照片</th>
											<th onclick="sort('youjian')">邮件<i id="youjianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#wuyezhanghaoSearch').val() != null && $('#wuyezhanghaoSearch').val() != ''){
				searchForm.wuyezhanghao ="%" +  $('#wuyezhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("wuye/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				wuyezhanghao : searchForm.wuyezhanghao,	
		...
		function setDataRow(item,number){
			...
			var youjianCell  = document.createElement('td');

						 youjianCell.innerHTML = item.youjian;

			row.appendChild(youjianCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("wuye/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"wuye");
