		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑小区规章</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>小区规章管理</span></li>
								<li class="breadcrumb-item active"><span>编辑小区规章</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">小区规章信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>内容</label>
										<input name="neirong" id="neirong" name="neirong" class="form-control" placeholder="内容">
									</div>
									<div class="form-group col-md-6">
										<label>封面图片</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xiaoquguizhang/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("xiaoquguizhang/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xiaoquguizhang/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xiaoquguizhang/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("xiaoquguizhang"+colName,"GET",{
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.neirong != null && res.data.neirong != ''){
						...
						$("#neirong").attr('readonly','readonly');
					}
