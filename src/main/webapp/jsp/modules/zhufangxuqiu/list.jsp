...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">住房需求管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>住房需求列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">住房需求列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xuqiu')">需求<i id="xuqiuIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('shifoujiejue')">是否解决<i id="shifoujiejueIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('xuqiuren')">需求人<i id="xuqiurenIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xuqiuCell  = document.createElement('td');

						 xuqiuCell.innerHTML = item.xuqiu;

			row.appendChild(xuqiuCell);
			var shifoujiejueCell  = document.createElement('td');

						  shifoujiejueCell.innerHTML = item.shifoujiejue; 

			row.appendChild(shifoujiejueCell);
			var xuqiurenCell  = document.createElement('td');

						 xuqiurenCell.innerHTML = item.xuqiuren;

			row.appendChild(xuqiurenCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhufangxuqiu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zhufangxuqiu");
