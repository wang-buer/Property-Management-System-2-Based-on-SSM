...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">住户报修管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>住户报修管理</span></li>
								<li class="breadcrumb-item active"><span>住户报修列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">住户报修列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										报修名称
									</label>
									<input type="text" id="baoxiumingchengSearch" class="form-control form-control-sm" placeholder="请输入报修名称" aria-controls="tableId">
									<label>
										类型
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('baoxiumingcheng')">报修名称<i id="baoxiumingchengIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#baoxiumingchengSearch').val() != null && $('#baoxiumingchengSearch').val() != ''){
				searchForm.baoxiumingcheng ="%" +  $('#baoxiumingchengSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("zhuhubaoxiu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				baoxiumingcheng : searchForm.baoxiumingcheng,	
		...
		function setDataRow(item,number){
			...
			var baoxiumingchengCell  = document.createElement('td');

						 baoxiumingchengCell.innerHTML = item.baoxiumingcheng;

			row.appendChild(baoxiumingchengCell);
			...
			var baoxiuneirongCell  = document.createElement('td');

						  if(item.baoxiuneirong != null && item.baoxiuneirong != "" && item.baoxiuneirong.length >= 11){
			  	baoxiuneirongCell.innerHTML = item.baoxiuneirong.substring(0, 10) + "..."; 
			  }else{
			  	baoxiuneirongCell.innerHTML = item.baoxiuneirong;
			  }


			row.appendChild(baoxiuneirongCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("zhuhubaoxiu/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("zhuhubaoxiu/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhuhubaoxiu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zhuhubaoxiu");
