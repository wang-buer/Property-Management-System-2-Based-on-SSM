	...
	<body>
				...
				<div class="recommend index-pv3" :style='{"padding":"8px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"00px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255, 255, 255, 0.3)","borderStyle":"solid"}'>
				  <div class="box" style='width:80%'>
				    ...
				    <div class="title" :style='{"isshow":true,"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(241, 58, 58, 1)","borderRadius":"32px","alignItems":"center","borderWidth":"0 10px","fontSize":"22px","borderStyle":"solid"}'>
				      <span>DATA SHOW</span><span>小区概况展示</span>
				    </div>
					...
					<div class="list-4">
					    <div v-if="xiaoqugaikuangList.length>0" class="list-4-item animation-box item-1" @click="jump('../xiaoqugaikuang/detail.jsp?id='+xiaoqugaikuangList[0].id)" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"400px","borderStyle":"solid","height":"400px"}'>
									<img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoqugaikuangList[0].tupian?baseurl+xiaoqugaikuangList[0].tupian.split(',')[0]:''" alt="" />
					    			<div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
										<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoqugaikuangList[0].xiaoqumingcheng}}</div>
					    			</div>
					    </div>
					    <div class="list-4-body">
					    			<div v-if="xiaoqugaikuangList.length>1" @click="jump('../xiaoqugaikuang/detail.jsp?id='+xiaoqugaikuangList[1].id)" class="list-4-item animation-box item-2" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"220px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoqugaikuangList[1].tupian?baseurl+xiaoqugaikuangList[1].tupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoqugaikuangList[1].xiaoqumingcheng}}</div>
					    			  </div>
					    			</div>
					    			<div v-if="xiaoqugaikuangList.length>2" @click="jump('../xiaoqugaikuang/detail.jsp?id='+xiaoqugaikuangList[2].id)" class="list-4-item animation-box item-3" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"220px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoqugaikuangList[2].tupian?baseurl+xiaoqugaikuangList[2].tupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoqugaikuangList[2].xiaoqumingcheng}}</div>
					    			  </div>
					    			</div>
					    </div>
					    <div class="list-4-body">
					    			<div v-if="xiaoqugaikuangList.length>3" @click="jump('../xiaoqugaikuang/detail.jsp?id='+xiaoqugaikuangList[3].id)" class="list-4-item animation-box item-4" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 0 20px 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"190px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoqugaikuangList[3].tupian?baseurl+xiaoqugaikuangList[3].tupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
								<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoqugaikuangList[3].xiaoqumingcheng}}</div>
					    			  </div>
					    			</div>
					    			<div v-if="xiaoqugaikuangList.length>4" @click="jump('../xiaoqugaikuang/detail.jsp?id='+xiaoqugaikuangList[4].id)" class="list-4-item animation-box item-5" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"190px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoqugaikuangList[4].tupian?baseurl+xiaoqugaikuangList[4].tupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoqugaikuangList[4].xiaoqumingcheng}}</div>
					    			  </div>
					    			</div>
					    </div>
					</div>
					<div class="clear"></div>
					<div style="text-align: center;">
					<button @click="jump('../xiaoqugaikuang/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"50px auto ","borderColor":"#ccc","backgroundColor":"#fff","color":"rgba(241, 58, 58, 1)","borderRadius":"6px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"30px"}'>查看更多<i v-if="true" :style='{"isshow":true,"padding":"0 0 0 10px","fontSize":"14px","color":"rgba(241, 58, 58, 1)"}' class="layui-icon layui-icon-next"></i></el-button>
					</div>
			...
			<!-- 图文列表 -->
				<div class="recommend index-pv3" :style='{"padding":"8px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"00px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255, 255, 255, 0.3)","borderStyle":"solid"}'>
				  <div class="box" style='width:80%'>
				    ...
				    <div class="title" :style='{"isshow":true,"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(255, 255, 255, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(241, 58, 58, 1)","borderRadius":"32px","alignItems":"center","borderWidth":"0 10px","fontSize":"22px","borderStyle":"solid"}'>
				      <span>DATA SHOW</span><span>小区规章展示</span>
				    </div>
					<div v-if="false && 1 == 2" class="idea listsIdea" :style='{"padding":"10px 5px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.3)","width":"100%","borderStyle":"solid","height":"auto"}'>
						<div class="box1"></div>
						<div class="box2"></div>
					...
					<div class="list-4">
					    <div v-if="xiaoquguizhangList.length>0" class="list-4-item animation-box item-1" @click="jump('../xiaoquguizhang/detail.jsp?id='+xiaoquguizhangList[0].id)" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"400px","borderStyle":"solid","height":"400px"}'>
									<img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoquguizhangList[0].fengmiantupian?baseurl+xiaoquguizhangList[0].fengmiantupian.split(',')[0]:''" alt="" />
					    			<div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
										<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoquguizhangList[0].biaoti}}</div>
					    			</div>
					    </div>
					    <div class="list-4-body">
					    			<div v-if="xiaoquguizhangList.length>1" @click="jump('../xiaoquguizhang/detail.jsp?id='+xiaoquguizhangList[1].id)" class="list-4-item animation-box item-2" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"220px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoquguizhangList[1].fengmiantupian?baseurl+xiaoquguizhangList[1].fengmiantupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoquguizhangList[1].biaoti}}</div>
					    			  </div>
					    			</div>
					    			<div v-if="xiaoquguizhangList.length>2" @click="jump('../xiaoquguizhang/detail.jsp?id='+xiaoquguizhangList[2].id)" class="list-4-item animation-box item-3" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"220px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoquguizhangList[2].fengmiantupian?baseurl+xiaoquguizhangList[2].fengmiantupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoquguizhangList[2].biaoti}}</div>
					    			  </div>
					    			</div>
					    ...
					    <div class="list-4-body">
					    			<div v-if="xiaoquguizhangList.length>3" @click="jump('../xiaoquguizhang/detail.jsp?id='+xiaoquguizhangList[3].id)" class="list-4-item animation-box item-4" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0 0 20px 0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"190px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoquguizhangList[3].fengmiantupian?baseurl+xiaoquguizhangList[3].fengmiantupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
								<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoquguizhangList[3].biaoti}}</div>
					    			  </div>
					    			</div>
					    			<div v-if="xiaoquguizhangList.length>4" @click="jump('../xiaoquguizhang/detail.jsp?id='+xiaoquguizhangList[4].id)" class="list-4-item animation-box item-5" :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0, .3)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"190px","borderStyle":"solid","height":"190px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"#ccc","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"100%"}' :src="xiaoquguizhangList[4].fengmiantupian?baseurl+xiaoquguizhangList[4].fengmiantupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"0px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"100%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			  	<div class="line1" :style='{"padding":"0 6px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(240, 86, 84, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(240, 86, 84, 1)","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"44px","fontSize":"14px","borderStyle":"solid"}' class="list-4-item-title">{{xiaoquguizhangList[4].biaoti}}</div>
					    			  </div>
					    			</div>
					...
					<div class="clear"></div>
					<div style="text-align: center;">
					<button @click="jump('../xiaoquguizhang/list.jsp')" style="display: block;cursor: pointer;" type="button" :style='{"padding":"0 12px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"50px auto ","borderColor":"#ccc","backgroundColor":"#fff","color":"rgba(241, 58, 58, 1)","borderRadius":"6px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"30px"}'>查看更多<i v-if="true" :style='{"isshow":true,"padding":"0 0 0 10px","fontSize":"14px","color":"rgba(241, 58, 58, 1)"}' class="layui-icon layui-icon-next"></i></el-button>
					</div>
					<div v-if="false && 1 == 3" class="idea listsIdea" :style='{"padding":"10px 5px","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"10px 0","borderColor":"#ccc","borderRadius":"0","borderWidth":"0","background":"rgba(0,0,0,.3)","width":"100%","borderStyle":"solid","height":"auto"}'>
						<div class="box1"></div>
						<div class="box2"></div>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
                ...
                http.request(`xiaoqugaikuang/list`, 'get', {
					page: 1,
				}, function(res) {
					vue.xiaoqugaikuangList = res.data.list
					let flag = 4;
					let options = {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"slidesPerView":5,"loop":true,"spaceBetween":20,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					if(options.slidesPerView) {
					...
					if(flag == 3) {
						vue.$nextTick(() => {
							new Swiper ('#listsxiaoqugaikuang', options)
							new Swiper ('#listsxiaoquguizhang', options)
						})
					}
					// 商品列表样式五
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#lists-five-swiperxiaoqugaikuang', {
								loop: true,
								speed: 500,
                ...
                http.request(`xiaoquguizhang/list`, 'get', {
					page: 1,
				}, function(res) {
					vue.xiaoquguizhangList = res.data.list
					let flag = 4;
					let options = {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"slidesPerView":5,"loop":true,"spaceBetween":20,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					if(options.slidesPerView) {
					...
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#lists-five-swiperxiaoquguizhang', {
								loop: true,
								speed: 500,
								slidesPerView: Number(5),
								spaceBetween: Number(10),
