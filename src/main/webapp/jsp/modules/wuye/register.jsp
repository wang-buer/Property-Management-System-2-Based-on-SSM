	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">物业账号</label> 
							<input  name="wuyezhanghao" placeholder="物业账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">物业姓名</label> 
							<input  name="wuyexingming" placeholder="物业姓名" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">邮件</label> 
							<input  name="youjian" placeholder="邮件" class="form-control-i">
							</div>
							<div class="form-group">
