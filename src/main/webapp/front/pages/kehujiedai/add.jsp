			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.kehuxingming" type="text" :readonly="ro.kehuxingming" name="kehuxingming" id="kehuxingming" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">客户手机：</label>
						<div class="layui-input-block">
							<input v-model="detail.kehushouji" type="text" :readonly="ro.kehushouji" name="kehushouji" id="kehushouji" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="jiedaishijian" id="jiedaishijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(xingbie)', function (data) {
                    vue.detail.xingbie=data.value;
                                ...
                                jquery('#jiedaishijian').val(getCurDate());
				laydate.render({
					elem: '#jiedaishijian'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='kehuxingming'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.kehuxingming = true;
                                                continue;
                                        }
                                        if(o=='kehushouji'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.kehushouji = true;
                                                continue;
                                        }
                                        if(o=='xingbie'){
                                                vue.detail[o] = obj[o];
                                        ...
                                        if(o=='jiedaishijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jiedaishijian = true;
                                                jquery('#jiedaishijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='neirong'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('kehujiedai/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('kehujiedai' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
